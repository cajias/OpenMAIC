...
`lib/i18n/index.ts`, `lib/i18n/workbench.ts`,
[`lib/i18n/TRANSLATION_GUIDE.md`](lib/i18n/TRANSLATION_GUIDE.md),
`lib/hooks/use-i18n.tsx`, `components/language-switcher.tsx`,
`scripts/check-i18n-keys.mjs`, [`package.json:19`](package.json#L19),
[`packages/@openmaic/generation/src/outline-generator.ts:20,127-179`](packages/@openmaic/generation/src/outline-generator.ts#L20),
`lib/pbl/v2/api/locale.ts`, [`lib/pbl/v2/agents/planner.ts:129-134`](lib/pbl/v2/agents/planner.ts#L129-L134),
[`lib/pbl/v2/agents/instructor.ts:118-119,551-552`](lib/pbl/v2/agents/instructor.ts#L118-L119); evidence
...
[`lib/i18n/workbench.ts:1-16`](lib/i18n/workbench.ts#L1-L16): the presentation table
...
The registry is `supportedLocales` ([`lib/i18n/locales.ts:16-29`](lib/i18n/locales.ts#L16-L29)), a
`as const satisfies readonly LocaleEntry[]` array of `{ code, label, shortLabel }`.
`Locale` is derived from it ([`types.ts:3`](lib/i18n/types.ts#L3)) and `defaultLocale = 'zh-CN'`
([`types.ts:5`](lib/i18n/types.ts#L5)) — which is also `fallbackLng`.
...
- **The user's locale is stored in raw `localStorage` under the bare key
  `'locale'`** ([`lib/hooks/use-i18n.tsx:8,39,51`](lib/hooks/use-i18n.tsx#L8)), *not* through `KVStore` and
...
- **Prefix matching depends on array order.** [`TRANSLATION_GUIDE.md:6`](lib/i18n/TRANSLATION_GUIDE.md) states the
...
`workbench.tool.label.x`" ([`workbench.ts:12-16`](lib/i18n/workbench.ts#L12-L16)). The hook-free translator has the
...
[`lib/i18n/TRANSLATION_GUIDE.md`](lib/i18n/TRANSLATION_GUIDE.md) is the contract for contributors. Its rules:
...
[`package.json:19`](package.json#L19) → `node scripts/check-i18n-keys.mjs`. `LOCALES_DIR` is
...
never overwritten by the UI locale header" ([`lib/pbl/v2/api/locale.ts:8-16`](lib/pbl/v2/api/locale.ts#L8-L16)). The
...
([`lib/prompts/templates/interactive-outlines/system.md:18`](lib/prompts/templates/interactive-outlines/system.md)), and the instructor
...
([`lib/pbl/v2/agents/instructor.ts:552`](lib/pbl/v2/agents/instructor.ts#L552)). `x-user-locale` is additionally read by
[`app/api/generate/scene-content/route.ts:322`](app/api/generate/scene-content/route.ts#L322) and sent by two PBL client modules.

Precedence, where multiple signals exist:

| Consumer | Order |
| --- | --- |
| PBL planner | `project.languageDirective`, else the literal fallback string `'Match the language of the outline content above.'` ([`planner.ts:134`](lib/pbl/v2/agents/planner.ts#L134)) |
| PBL eval prompts | `project.languageDirective`, else `project.language`, else `'en-US'` ([`lib/pbl/v2/operations/runtime/eval-prompts.ts:40`](lib/pbl/v2/operations/runtime/eval-prompts.ts#L40)) |
| Scene generation | `params.languageDirective`, else `params.stageInfo.language` ([`lib/hooks/use-scene-generator.ts:833,1016`](lib/hooks/use-scene-generator.ts#L833)) |
...
- The stage document that carries it: [../07-dsl-renderer-editor/index.md](docs/07-dsl-renderer-editor/index.md)
- The workbench store that uses `defaultWorkbenchTranslator`:
  [03-client-state-stores.md](docs/10-persistence-and-state/03-client-state-stores.md)
- CI gates in full: [../16-development-view/index.md](docs/16-development-view/index.md)
