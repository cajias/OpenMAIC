...
are in [./01-provider-registry.md](docs/04-ai-provider-layer/01-provider-registry.md).

**Sources:** [`lib/ai/providers.ts:1599-2338`](lib/ai/providers.ts#L1599-L2338), `lib/ai/reasoning-sse.ts`,
`lib/ai/thinking-context.ts`, `lib/ai/azure.ts`, [`lib/server/provider-config.ts:328,363,735`](lib/server/provider-config.ts#L328),
`package.json`;
...
spelled out twice: the header comment at [`lib/ai/providers.ts:59`](lib/ai/providers.ts#L59)–[`:62`](lib/ai/providers.ts#L62) and the module docstring at
[`lib/ai/thinking-context.ts:8`](lib/ai/thinking-context.ts#L8)–[`:13`](lib/ai/thinking-context.ts#L13), where the `AsyncLocalStorage` is published onto `globalThis`
...
([`lib/ai/llm.ts:348`](lib/ai/llm.ts#L348), [`:421`](lib/ai/llm.ts#L421)), so any call that bypasses those wrappers leaves `compatFetch` with no
config — which is one of the three things the ESLint funnel exists to prevent
([`eslint.config.mjs:17`](eslint.config.mjs#L17)).

### `getCompatThinkingBodyParams` — 12 vendor body shapes

[`lib/ai/providers.ts:1599`](lib/ai/providers.ts#L1599). One hard-coded model special case runs ahead of the switch: the `openai`
...
| `none`, `anthropic`, `google` | `undefined` — the native adapters go through `providerOptions` in [`lib/ai/llm.ts:140`](lib/ai/llm.ts#L140) instead |
...
- **`kimi:kimi-k3`** needs a round trip. `createKimiReasoningPreservationMiddleware`
  ([`lib/ai/reasoning-sse.ts:66`](lib/ai/reasoning-sse.ts#L66)) encodes assistant reasoning parts as length-prefixed sentinel text
  (`KIMI_REASONING_MARKER`, `:28`), and `restoreKimiReasoningInRequestBody` (`:88`, called at
  [`providers.ts:2141`](lib/ai/providers.ts#L2141)) decodes them back into `reasoning_content` **after** SDK serialization. Its
...
comment at [`providers.ts:2211`](lib/ai/providers.ts#L2211)–[`:2216`](lib/ai/providers.ts#L2216) states the round trip.

## The other four branches

| Branch | What is not obvious |
| --- | --- |
| `azure` (`:2070`) | Only `createAzure({apiKey, baseURL: normalizeAzureBaseUrl(effectiveBaseUrl)})` then `azure(modelId)`. No compat shim, no reasoning middleware, and `azure.models` is `[]`, so `modelInfo` is `null` unless the operator declares `providers.azure.models[]` capabilities in `server-providers.yml` — `getServerModelInfo` ([`lib/server/provider-config.ts:709`](lib/server/provider-config.ts#L709)) then becomes the whole `ModelInfo` at the merge (`:2323`–`:2335`) |
...
`config.proxy` is populated by `resolveProxy()` ([`lib/server/provider-config.ts:735`](lib/server/provider-config.ts#L735)) from
...
[`lib/ai/providers.ts:1883`](lib/ai/providers.ts#L1883). Some gateways answer correctly only with `stream: true`.
...
| --- | --- | --- | --- |
| `ai` | `^6.0.168` | `generateText`, `streamText`, `wrapLanguageModel`, `extractReasoningMiddleware`, `APICallError`, `RetryError` | [`package.json:89`](package.json#L89); [`lib/ai/providers.ts:34`](lib/ai/providers.ts#L34), [`lib/ai/llm.ts:7`](lib/ai/llm.ts#L7), [`lib/server/llm-error-response.ts:1`](lib/server/llm-error-response.ts#L1) |
| `@ai-sdk/openai` | `^3.0.84` | `createOpenAI` — 14 providers | [`lib/ai/providers.ts:29`](lib/ai/providers.ts#L29) |
| `@ai-sdk/anthropic` | `^3.0.71` | `createAnthropic` — `anthropic`, `minimax` | [`lib/ai/providers.ts:31`](lib/ai/providers.ts#L31) |
| `@ai-sdk/azure` | `^3.0.88` | `createAzure` | [`lib/ai/providers.ts:30`](lib/ai/providers.ts#L30) |
| `@ai-sdk/amazon-bedrock` | `^4.0.103` | `createAmazonBedrock` | [`lib/ai/providers.ts:32`](lib/ai/providers.ts#L32) |
| `@ai-sdk/google` | `^3.0.64` | `createGoogleGenerativeAI` | [`lib/ai/providers.ts:33`](lib/ai/providers.ts#L33) |
| `@aws-sdk/credential-providers` | `^3.1045.0` | `fromNodeProviderChain()`, dynamically imported | [`lib/ai/providers.ts:1794`](lib/ai/providers.ts#L1794) |
| `undici` | `7.29.0` | `ProxyAgent` for the Google proxy path, dynamically imported | [`lib/ai/providers.ts:2295`](lib/ai/providers.ts#L2295) |
| `@earendil-works/pi-ai` | `0.78.0` (pinned exact) | `Api` / `Model` types for the agent driver | [`lib/server/agent-runtime/agent-driver-model.ts:1`](lib/server/agent-runtime/agent-driver-model.ts#L1) |

Full dependency accounting lives in [../13-dependencies/index.md](docs/13-dependencies/index.md).
...
- Three empty `catch { /* leave body as-is */ }` blocks sit in the fetch shims
  ([`lib/ai/providers.ts:2127`](lib/ai/providers.ts#L2127), [`:2143`](lib/ai/providers.ts#L2143), [`:2261`](lib/ai/providers.ts#L2261)). They are unreachable while the AI SDK produces the
